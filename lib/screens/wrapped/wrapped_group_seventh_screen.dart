...
/// Pantalla 7 del wrapped grupal (índice 6 del slideshow): Horarios de mensajes.
/// Misma maquetación que la pantalla 5 individual (`WrappedSixthScreen`).
class WrappedGroupSeventhScreen extends StatefulWidget {
  ...
  @override
  State<WrappedGroupSeventhScreen> createState() =>
      _WrappedGroupSeventhScreenState();
}

class _WrappedGroupSeventhScreenState extends State<WrappedGroupSeventhScreen>
  ...
  Future<void> _runAnimations() async {
    ...
    if (!_animationsCompleted) {
      ...
      widget.onGroupScreenAnimationsComplete?.call(6);
    }
  }
